...
cd movie-search-app</code></pre>
  ...
  <div class="section">
   ...
   <img src="https://github.com/aakritibagri/Movie_Search_App/blob/main/Screenshot%202025-11-03%20122228.png?raw=true" width=80% height=80%>
   <img src="https://github.com/aakritibagri/Movie_Search_App/blob/main/Screenshot%202025-11-03%20122249.png?raw=true" width=80% height=80%>
  <div class="section">
    <h2>🧭 Usage</h2>
    <ul>
